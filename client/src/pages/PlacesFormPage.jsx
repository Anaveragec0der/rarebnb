 ...
 export default function PlacesFormPage(){
    ...
    return(
        ...
        <form onSubmit={savePlace}>
              {preInput('Title','Title for your palce, should be short and catchy as in advertisement')}
              ...
              {preInput('Check in & out time','Add check in & out times, remember to have some time window for cleaning before the guests arrive')}
              <div className="grid gap-2 grid-cols-2 md:grid-cols-4">
                ...
                <div>
                  ...
                  <input type="text" value={checkOut} onChange={e=>setCheckOut(e.target.value)} placeholder="20"/>
                </div>
                <div>
